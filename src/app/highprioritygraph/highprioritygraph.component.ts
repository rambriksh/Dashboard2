...
@Component({
  selector: 'app-highprioritygraph',
  templateUrl: './highprioritygraph.component.html',
  styleUrls: ['./highprioritygraph.component.css']
})
...
gotopage()
{
  this.router.navigate(['/highprioritylist']);
}
}
